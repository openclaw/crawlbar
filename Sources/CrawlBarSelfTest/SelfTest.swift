...
enum CrawlBarSelfTest {
    static func main() throws {
        ...
        try Self.testStatusMapperWhatsAppStoreStates()
        try Self.testStatusMapperCrawlKitArchives()
        try Self.testStatusMapperTelegramFreshness()
        try Self.testStatusMapperCrawlKitStates()
        try Self.testStatusMapperGitHubFailures()
